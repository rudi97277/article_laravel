    ...
    <div id="background" style="text-align: left; background-color:#f6f6f6;">
        <div id="content" style=" background-color:white; margin:auto">
            ...
            <div id="inner-content" style="padding: 20px;">
                ...
                <p>Membership anda telah {{$verified ? 'diaktifkan. Berikut merupakan kartu membership anda' : 'dinonaktifkan'}}.</p>
                @if ($verified)
                    <img src="https://articles.iarn.or.id/images/card.png" alt="IEIA" style="width: 90%" >
                @endif
                <p><br></p>
